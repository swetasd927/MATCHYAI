...
export default function MatchCard({ match }: { match: Match }) {
  return (
    <div className="card p-6 space-y-4">
      ...
      {match.explanation && (
        <div className="rounded-[var(--radius-md)] p-4 flex gap-3"
          ...
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-wider mb-1 text-[var(--primary)]">AI Match Insight</h4>
      ...
      <div className="flex flex-wrap gap-2">
        {match.skills.slice(0, 6).map((skill) => (
          <span key={skill} className="px-2.5 py-1 text-xs font-[family-name:var(--font-mono)] rounded-full"
